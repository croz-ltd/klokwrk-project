 ...
 * </p>
 * Main reason for this class it to be able to create a library-like {@link net.croz.cargotracker.infrastructure.project.web.spring.mvc.ResponseFormattingExceptionHandler} class which is not automatically (via component scanning) included in Spring context.
 ...
 * {@link ResponseFormattingExceptionHandler}.
 * </p>
