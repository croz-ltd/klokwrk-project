...
class HexagonalCqrsEsArchitecture implements ArchRule {
  ...
  static final String DOMAIN_MODEL_VALUE_LAYER = "domain model value"
  ...
  private String[] domainModelValuePackageIdentifiers = []
  ...
  private HexagonalCqrsEsArchitecture copyWith(String overriddenDescription) {
    HexagonalCqrsEsArchitecture newHexagonalCqrsEsArchitecture = new HexagonalCqrsEsArchitecture(architectureSubType, overriddenDescription)
        .domainModelValues(domainModelValuePackageIdentifiers)
  ...
  HexagonalCqrsEsArchitecture domainModelValues(String... packageIdentifiers) {
    domainModelValuePackageIdentifiers = packageIdentifiers
    return this
  }
  ...
  private void specifyArchitectureDefault(LayeredArchitecture layeredArchitecture) {
    ...
    layeredArchitecture
        .layer(DOMAIN_MODEL_VALUE_LAYER).definedBy(domainModelValuePackageIdentifiers)
        ...
        .whereLayer(DOMAIN_MODEL_VALUE_LAYER)
  ...
  private void specifyArchitectureProjection(LayeredArchitecture layeredArchitecture) {
    // @formatter:off
    layeredArchitecture
        .optionalLayer(DOMAIN_MODEL_VALUE_LAYER).definedBy(domainModelValuePackageIdentifiers)
        .layer(DOMAIN_EVENT_LAYER).definedBy(domainEventPackageIdentifiers)

        .layer(ADAPTER_PROJECTION_LAYER).definedBy(adapterProjectionPackageIdentifiers.collect({ Map.Entry<String, String[]> mapEntry -> mapEntry.value }).flatten() as String[])

        .whereLayer(DOMAIN_MODEL_VALUE_LAYER).mayOnlyBeAccessedByLayers(DOMAIN_EVENT_LAYER, ADAPTER_PROJECTION_LAYER)
  ...
  private void specifyArchitectureQuerySide(LayeredArchitecture layeredArchitecture) {
    ...
    layeredArchitecture
        ...
        .whereLayer(DOMAIN_MODEL_VALUE_LAYER).mayOnlyBeAccessedByLayers(APPLICATION_SERVICE_LAYER, APPLICATION_OUTBOUND_PORT_LAYER, ADAPTER_OUTBOUND_LAYER)
  ...
  String getDescription() {
    ...
    lines.with {
      addAll(describeStandardPackageIdentifiers(domainModelValuePackageIdentifiers, "domain model value objects"))
