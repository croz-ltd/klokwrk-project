...
class MessageSourceResolvableHelper {
   ...
   */
  static String resolveMessageCodeList(MessageSource messageSource, List<String> messageCodeList, Locale locale, String defaultMessage = null, List<String> messageParameters = []) {
