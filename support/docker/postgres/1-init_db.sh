...
# It should be the same as a script at location klokwrk-project/modules/bc/cargotracker/asd/booking/lib/cargotracker-booking-test-support-testcontainers/src/main/resources/postgresql/init/1-init_db.sh
