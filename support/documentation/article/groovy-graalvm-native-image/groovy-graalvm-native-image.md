...
As nothing comes in a vacuum, it coincided with a need for creating a [small command-line utility](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/README.md) [13] and
...
To help with this process, we created the [klokwrk-tool-gradle-source-repack](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/README.md) submodule. To explore its role in the process of debugging
...
Therefore, this article will use [klokwrk-tool-gradle-source-repack](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/README.md) as a working example. For a more comfortable
...
[build.gradle](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/build.gradle) file.
...
[GroovyDgmClassesRegistrationFeature](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/src/main/java/org/klokwrk/tool/gradle/source/repack/graal/GroovyDgmClassesRegistrationFeature.java)
...
by default), we need to edit [kwrk-graal.properties](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/src/main/resources/kwrk-graal.properties):
```
...
provides another native image builder extension - [GroovyApplicationRegistrationFeature](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/src/main/java/org/klokwrk/tool/gradle/source/repack/graal/GroovyApplicationRegistrationFeature.java).
...
[kwrk-graal.properties](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/src/main/resources/kwrk-graal.properties) file:
```
...
In the `download()` method of the [GradleDownloader](../../../../modules/other/tool/klokwrk-tool-gradle-source-repack/src/main/groovy/org/klokwrk/tool/gradle/source/repack/downloader/GradleDownloader.groovy)
