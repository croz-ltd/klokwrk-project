...
In `kolkwrk-project`, the general response metadata structures are implemented in classes of `org.klokwrk.cargotracker.lib.boundary.api.metadata.response` package from `cargotracker-lib-boundary-api`
