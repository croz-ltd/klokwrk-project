...
class BookingOfferDetailsFindByIdQueryResponseContentPayloadAssertion {
  ...
  BookingOfferDetailsFindByIdQueryResponseContentPayloadAssertion hasCargosWithFirstCargoThat(
      ...
      @ClosureParams(
          value = SimpleType,
          options = 'org.klokwrk.cargotracker.booking.queryside.view.feature.bookingoffer.application.port.in.assertion.BookingOfferDetailsFindByIdQueryResponseContentPayloadAssertion$CargoAssertion'
      ) Closure aClosure)
  {
  ...
  BookingOfferDetailsFindByIdQueryResponseContentPayloadAssertion hasRouteSpecificationThat(
      ...
      @ClosureParams(
          value = SimpleType,
          options = 'org.klokwrk.cargotracker.booking.queryside.view.feature.bookingoffer.application.port.in.assertion.BookingOfferDetailsFindByIdQueryResponseContentPayloadAssertion$RouteSpecificationAssertion'
      ) Closure aClosure)
  {
