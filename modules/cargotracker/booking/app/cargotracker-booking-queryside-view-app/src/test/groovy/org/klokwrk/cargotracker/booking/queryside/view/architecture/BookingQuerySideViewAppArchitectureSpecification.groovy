...
class BookingQuerySideViewAppArchitectureSpecification extends Specification {
  ...
  void "axon query handler adapters should not implement any interface from application outbound ports"() {
    ...
    ArchRule inboundAdapterDoesNotAccessApplicationServiceDirectlyRule = ArchRuleDefinition
        .noClasses().that()
            .resideInAPackage("org.klokwrk.cargotracker.booking.queryside.view.feature.*.adapter.out..")
        ...
        .should()
            .dependOnClassesThat().resideInAPackage("org.klokwrk.cargotracker.booking.queryside.view.feature.*.application.port.out..")
    // @formatter:on
  ...
  void "should be valid hexagonal queryside CQRS/ES architecture"() {
    ...
    ArchRule rule = HexagonalCqrsEsArchitecture
        ...
        .adapterInbound("in.web", "..cargotracker.booking.queryside.view.feature.*.adapter.in.web..")
        .adapterOutbound(
            "out.persistence",
            [
                "..cargotracker.booking.queryside.view.feature.*.adapter.out.persistence..",
