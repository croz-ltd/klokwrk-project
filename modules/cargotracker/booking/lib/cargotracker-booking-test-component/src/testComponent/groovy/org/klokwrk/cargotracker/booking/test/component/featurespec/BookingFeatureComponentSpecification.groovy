...
import static org.klokwrk.cargotracker.booking.test.component.test.util.BookingFeatureTestHelpers.bookingOfferSummaryFindAll_succeeded
import static org.klokwrk.cargotracker.booking.test.component.test.util.BookingFeatureTestHelpers.bookingOfferSummaryFindById_notFound
import static org.klokwrk.cargotracker.booking.test.component.test.util.BookingFeatureTestHelpers.bookingOfferSummaryFindById_succeeded
import static org.klokwrk.cargotracker.booking.test.component.test.util.BookingFeatureTestHelpers.bookingOfferSummarySearchAll_succeeded
import static org.klokwrk.cargotracker.booking.test.component.test.util.BookingFeatureTestHelpers.createBookingOffer_failed
import static org.klokwrk.cargotracker.booking.test.component.test.util.BookingFeatureTestHelpers.createBookingOffer_succeeded
import static org.klokwrk.cargotracker.booking.test.component.test.util.BookingFeatureTestHelpers.makeCommandRequestBodyList_createBookingOffer
