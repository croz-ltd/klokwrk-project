 ...
 * <p/>
 * Corresponding Slf4j logger uses '<code>cargotracking-lib-axon-logging.eventsourcing-handler-logger</code>' category and it logs on <code>DEBUG</code> level. Logger output contains information
...
class LoggingEventSourcingHandlerEnhancerDefinition implements HandlerEnhancerDefinition {
  ...
  @Slf4j(category = "cargotracking-lib-axon-logging.eventsourcing-handler-logger")
