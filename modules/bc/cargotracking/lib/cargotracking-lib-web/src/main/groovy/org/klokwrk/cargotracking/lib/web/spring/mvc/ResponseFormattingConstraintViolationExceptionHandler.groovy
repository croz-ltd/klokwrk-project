...
import org.klokwrk.cargotracking.lib.boundary.api.application.metadata.response.ResponseMetaDataValidationReportPart
import org.klokwrk.cargotracking.lib.boundary.api.application.metadata.response.ResponseMetaDataViolationPart
import org.klokwrk.cargotracking.lib.boundary.api.application.metadata.response.ValidationReportConstraintViolation
import org.klokwrk.cargotracking.lib.boundary.api.application.metadata.response.ValidationReportRoot
