 ...
 */
package org.klokwrk.lib.lo.archunit.samplepackages.architecture.hexagonal.cqrses.violation.domain.model.command
...
@CompileStatic
class DomainCommandViolationClass {
  ...
  DomainCommandViolationClass() {
  }

  DomainCommandViolationClass(ApplicationPortInViolationInterface applicationPortInViolationInterface, ApplicationPortOutViolationInterface applicationPortOutViolationInterface) {
