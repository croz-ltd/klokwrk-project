...
import org.klokwrk.lib.lo.archunit.samplepackages.architecture.hexagonal.cqrses.valid.adapter.projection.AdapterProjectionClass
...
class HexagonalCqrsEsArchitectureSpecification extends Specification {
  ...
  void setupSpec() {
    importedValidClasses = ArchUnitUtils.importJavaClassesFromPackages(["org.klokwrk.lib.lo.archunit.samplepackages.architecture.hexagonal.cqrses.valid"], [], [])
    importedViolationClasses = ArchUnitUtils.importJavaClassesFromPackages(["org.klokwrk.lib.lo.archunit.samplepackages.architecture.hexagonal.cqrses.violation"], [], [])
  }
