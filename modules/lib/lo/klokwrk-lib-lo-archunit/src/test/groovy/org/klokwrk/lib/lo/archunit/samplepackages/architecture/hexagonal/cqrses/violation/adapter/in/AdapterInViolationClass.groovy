 ...
 */
package org.klokwrk.lib.lo.archunit.samplepackages.architecture.hexagonal.cqrses.violation.adapter.in
...
class AdapterInViolationClass {
  DomainModelValueViolationClass domainModelViolationClass = new DomainModelValueViolationClass()
