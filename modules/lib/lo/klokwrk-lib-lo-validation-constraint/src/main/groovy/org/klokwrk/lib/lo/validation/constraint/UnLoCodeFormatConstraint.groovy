 ...
 * <p/>
 * Accepts only {@code String} types. Message interpolation key is {@code org.klokwrk.lib.lo.validation.constraint.UnLoCodeFormatConstraint.message}.
 * <p/>
...
@interface UnLoCodeFormatConstraint {
  String message() default "{org.klokwrk.lib.lo.validation.constraint.UnLoCodeFormatConstraint.message}"
