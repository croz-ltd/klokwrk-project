 ...
 * <p/>
 * Default message interpolation key is {@code org.klokwrk.lib.validation.constraint.NotBlankWhenNullableConstraint.message}.
 */
@Documented
...
@interface TrimmedStringConstraint {
  String message() default "{org.klokwrk.lib.validation.constraint.TrimmedStringConstraint.message}"
