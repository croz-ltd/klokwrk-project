...
class BookCargoRequest {
  ...
  // Not null and not blank if not null, and must be in unLoCode format. After formal validation passes (1st level validation), it also must exist in the location registry (2nd level validation).
  @NotNull
