 ...
 * <p/>
 * Main reason for this class it to be able to create a library-like {@link ResponseFormattingDomainExceptionHandler} class which is not automatically (via component scanning) included in Spring
 ...
 * <p/>
 * In our case, <code>ResponseFormattingDomainExceptionHandlerControllerAdvice</code> is picked-up by auto-scanning from <code>BookingQuerySideApplication</code>.
 * <p/>
