...
class ViolationCode implements PostMapConstructorCheckable {
   ...
   * easier for developers to deduct the meaning of <code>cargoSummaryQueryWebController.cargoSummaryQuery.failure.other.badRequest</code> resource bundle key instead the meaning of
   * <code>cargoSummaryQueryWebController.cargoSummaryQuery.failure.other.400</code> key. And this is exactly the intention behind this property.
   * <p/>
