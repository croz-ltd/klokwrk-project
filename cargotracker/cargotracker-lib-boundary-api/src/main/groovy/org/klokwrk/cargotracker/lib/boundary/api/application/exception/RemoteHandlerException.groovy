 ...
 * @see org.klokwrk.cargotracker.lib.boundary.api.domain.exception.CommandException
 * @see org.klokwrk.cargotracker.lib.boundary.api.domain.exception.QueryException
 */
@CompileStatic
