 ...
 */
package org.klokwrk.cargotracker.booking.queryside.test.feature.cargoinfo.sql
...
class CargoSummarySqlHelper {
  ...
  static Map<String, ?> selectCargoSummaryRecord(Sql groovySql, String bookingOfferIdentifier) {
